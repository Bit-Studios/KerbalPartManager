...
[BepInPlugin("computer.shadow.mods.bpm", "BetterPartsManager", "2.2.0")]
public class BetterPartsManagerMod : BaseUnityPlugin
{
    ...
    void GameStateChanged(MessageCenterMessage messageCenterMessage)
    {
        ...
        else
        {
            ...
            //refreshIcon.LoadImage(File.ReadAllBytes($"./BepInEx/plugins/BetterPartsManagerLegacy/assets/images/refresh.png"));
